...
<div className="mt-3">
<h2>Originally on <a href="https://www.nytimes.com/2022/09/19/health/doctor-burnout-west-virginia.html" target="_blank" className="underline hover:text-gray-400">NYT</a> | Art & Interactivity by <a href="https://www.gabkdejesus.com" target="_blank" className="underline hover:text-gray-400">Gab K De Jesus</a></h2>
<span>&#8592; </span><a href="https://gabkdejesus.com/"  className="underline hover:text-gray-400">Back to Home</a>
</div>
...
<section className="mb-10 mt-10">
    <p>Gab here, I hope you enjoyed the interactive article. If you're interested in seeing behind-the-scenes, stay tuned on my <a href="https://www.gabkdejesus.com" target="_blank" className="underline hover:text-gray-400">website</a>!</p>
    <span>&#8592; </span><a href="https://gabkdejesus.com/"  className="underline hover:text-gray-400">Back to Home</a>
</section>